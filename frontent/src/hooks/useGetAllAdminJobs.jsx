...
// import { setAllAdminJobs } from '../redux/JobSlice' // 🔥 FIXED: Changed setAllJob to setAllAdminJobs
...
//   useEffect(() => {
//     // ■ SECURITY FIX: Only fetch admin jobs if the user is actually a recruiter
//     if (user?.role === 'recruiter') {
//       const fetchAllAdminJobs = async () => {
//         try {
//           const res = await axios.get(
//             "http://localhost:8000/job/getAdminJob",
