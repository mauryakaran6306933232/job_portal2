...
//     setLoading(true);
//     try {
//       const res = await axios.post("http://localhost:8000/job/post", formData, {
...
//                 <option key={company1?._id} value={company1._id}>{company1?.name}</option>
//               ))}
//             </select>
//             {companies?.length === 0 && (
//               <p className='text-red-500 text-xs mt-1'>You haven't created any companies yet. Please create one first.</p>
//             )}
//           </div>
