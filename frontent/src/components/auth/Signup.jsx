...
//     // 🔥 REFERRAL SYSTEM: Capture referral code from URL (?ref=CODE)
...
//     // Keeping file separate because FormData handles files differently
...
//             // 🔥 REFERRAL SYSTEM: Append the referral code if it exists in the URL
//             if (referralCode) {
...
//             <div className='hidden md:flex w-1/2 bg-gradient-to-br from-indigo-600 to-[#6A38C2] text-white flex-col justify-center items-center p-12 relative overflow-hidden'>
//                 <Link to="/" className='absolute top-8 left-8 text-2xl font-extrabold tracking-tight'>
//                     Job<span className='text-indigo-200'>Portal</span>
//                 </Link>
//                 <h1 className='text-5xl font-extrabold mb-4 z-10'>Join Us Today!</h1>
...
//                 </p>
//                 <div className='mt-8 z-10 opacity-90'>
//                     <img src="https://illustrations.popsy.co/white/crostata/select.svg" alt="Sign up" className='w-80 rounded-xl' />
//                 </div>
//             </div>
...
//                         {/* 🔥 Show a small message if they were referred */}
//                         {referralCode && (
//                             <p className="mt-2 text-sm text-green-600 font-medium">🎉 You were referred! Welcome aboard.</p>
//                         )}
//                     </div>

//                     <form onSubmit={signupHandler} className='bg-white p-8 rounded-2xl shadow-sm border border-gray-100'>
//                         <div className='mb-4'>
...
//                             <RadioGroup
//               value={input.role} // ■ CHANGED FROM defaultValue TO value
...
//                                 <Button type="button" variant="outline" onClick={() => document.getElementById('profilePhoto').click()} className="text-gray-500">
