...
//         // ■■■ NEW: Emit real-time event to all users ■■■
//         const io = req.app.get("io");
//         if (io) {
//             io.emit("jobListUpdated"); // Triggers students' feed to refresh!
//         }
...
//                 success: false,
//                 message: 'job is not exist from this id'
//             })
//         }
//         return res.status(201).json({
//             success: true,
...
//             return res.status(401).json({
//                 success: true,
//                 message: 'job has not found by admin'
...
//         return res.status(401).json({
//             success : false,
//             message : 'backend error in getAdminJob'
//         })
//     }
// }
import Job from "../models/job.model.js";
